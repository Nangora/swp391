        ...
        <div class="container d-flex align-items-center justify-content-between">
            <div class="top-bar-contact d-flex align-items-center">
                <ul class="d-flex align-items-center">
                    <li><a href="#"><i class="fa-solid fa-phone"></i>+84 3497 94140</a></li>
                    <li><a href="mailto: huyddhe181196@fpt.edu.vn" target="_blank"><i class="fa-regular fa-envelope"></i>group1@gmail.com</a></li>
